...
function LogIn() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 to-indigo-100 pt-24">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 sm:p-10">
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-600">
                ...
                <Link 
                  to="/signup" 
                  className="text-blue-600 hover:text-blue-500 font-semibold transition-colors flex items-center justify-center gap-1"
                >
